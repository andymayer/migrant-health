  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new HowTo" do
        expect {
          post :create, params: {how_to: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {how_to: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested how_to" do
        how_to = HowTo.create! valid_attributes
        put :update, params: {id: how_to.to_param, how_to: new_attributes}, session: valid_session
        how_to.reload
      ...
      it "redirects to the how_to" do
        how_to = HowTo.create! valid_attributes
        put :update, params: {id: how_to.to_param, how_to: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        how_to = HowTo.create! valid_attributes
        put :update, params: {id: how_to.to_param, how_to: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
